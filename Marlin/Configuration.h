...
#define STRING_CONFIG_H_AUTHOR "(Ender3SwissMini)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 47.53
    #define DEFAULT_Ki 8.24
    #define DEFAULT_Kd 68.59
  #endif
#endif // PIDTEMP
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46, -9.5, 0 }
